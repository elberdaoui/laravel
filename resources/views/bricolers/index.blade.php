        ...
        <table class="table table-hover nowrap" id="example1" width="100%">
            ...
            <tr>
               ...
               <td style="width:250px;">
                    <a href="{{ route('bricoler.edit',$bricoler->id ) }}" class="btn btn-primary" style="margin-left:40px;"> Edit</a>
                   {!! Form::open(['method' => 'DELETE','route' => ['bricoler.destroy', $bricoler->id],'style'=>'display:inline','role'=>'form','onsubmit' => 'return confirm("Do you want to delete this ?")']) !!}
