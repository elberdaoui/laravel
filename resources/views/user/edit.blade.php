   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
            ...
            @endif
            <div class="col-lg-12">
            <form action="{{ url('userUpdate',$user->user_id) }}" method="post" name="form_update_user" enctype="multipart/form-data">

				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-username">User Name <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="validation-username" class="form-control" value="{{$user->username}}"  placeholder="Username"   name="user_name"  type="text" data-validation="[NOTEMPTY]" data-validation-message="User Name must not be empty!">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="description"  rows="4" id="l15" name="user_description" placeholder="User description">{{$user->description}}</textarea>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="email">Email <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="email" class="form-control"  placeholder="Email" value="{{$user->email}}"   name="email"  type="email" data-validation="[NOTEMPTY]" data-validation-message="Email must not be empty!">
                        </div>
                    </div>
                     <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div >
                                <img src="{{ asset('/storage/'.$user->profile_image) }}" alt="profile_image" style="width: 100%;height:200px" >
                            </div>
                        </div>
                    </div>
                </div>
               ...
               <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-actions">
                    ...
                    <a href="{{ url('listUsers')}}"  class="btn btn-default">Cancel</a>
                </div>
			</form>
            </div>
