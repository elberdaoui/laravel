   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <?php endif; ?>
            <div class="col-lg-12">
            <form action="<?php echo e(url('sectorstore')); ?>" method="post" name="form_add_secteur" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-sector">Sector Name<span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="validation-sector" class="form-control"  placeholder="Sector Name"   name="sector_name"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Sector nae  must not be empty!">
                        </div>
                    </div>
                </div>
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(url('secteurCreate')); ?>"  class="btn btn-default">Cancel</a>
                </div>
			</form>
            </div>
