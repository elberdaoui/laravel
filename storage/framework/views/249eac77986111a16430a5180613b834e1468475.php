                 ...
                 <?php
                   ...
                   ?>   
                    <a class="cat__core__avatar cat__core__avatar--border-white cat__core__avatar--110" href="javascript:void(0);">
                        <img src="<?php echo e(asset('/storage/'.$profileimage->profile_image)); ?>" alt="Alternative text to the image">
                    </a>   
                   <?php }else{ ?>
                          <a class="cat__core__avatar cat__core__avatar--border-white cat__core__avatar--110" href="javascript:void(0);">
                             <img src="<?php echo e(asset('/upload/profileimage/profile.jpg')); ?>" alt="Alternative text to the image">
                           </a>
                   <?php } ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group"><br>
                                        ...
                                        <img src="<?php echo e(asset('/storage/'.$profileimage->profile_image)); ?>" style="height: 300px;"><br><br>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                           ...
                           <?php echo Form::open(array('url' => ['/update/'.$profileimage->user_id],'method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group"><br>
                                        <label class="form-control-label" for="l6"><b>Profile Image</b></label><br><br>
                                        <img src="<?php echo e(asset('/storage/'.$profileimage->profile_image)); ?>" style="height: 300px;">&nbsp; &nbsp;&nbsp; &nbsp;
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control" >
                                            <option value="Admin" <?php if(Auth::user()->role == 'Admin'): ?> selected <?php endif; ?>>Admin</option>
                                            <option value="User" <?php if(Auth::user()->role == 'User'): ?> selected <?php endif; ?>>User</option>
                                        </select>
                                    </div>
                                </div>
                            </div><br>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="user_description" class="form-control" cols="10" rows="5"><?php echo e(Auth::user()->description); ?></textarea>
                                    </div>
                                </div>
                            </div>
