<?php $__env->startSection('title', 'Update City'); ?>
   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <?php endif; ?>
            <div class="col-lg-12">
            <form action="<?php echo e(url('villeUpdate',$ville->id)); ?>" method="post" name="form_add_secteur" >
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-ville">City<span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                        <input id="validation-ville" value="<?php echo e($ville->nom_ville); ?>" class="form-control"  placeholder="City name"   name="ville"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Sector nae  must not be empty!">
                        </div>
                    </div>
                </div>
