   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <?php endif; ?>
            <div class="col-lg-12">
            <form action="<?php echo e(url('userstore')); ?>" method="post" name="form_add_user" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(url('userCreate')); ?>"  class="btn btn-default">Cancel</a>
                </div>
			</form>
            </div>
