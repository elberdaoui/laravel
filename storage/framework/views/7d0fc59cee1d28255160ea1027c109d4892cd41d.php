<?php $__env->startSection('title', 'Add Bricoler'); ?>
   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-lg-12">
			 <?php echo Form::open(array('route' => 'bricoler.store','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation','enctype'=>'multipart/form-data')); ?>
                            ...
                            <label for="secteur_id">Secteurs <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                              <select type="text" class="form-control" name="secteur_id" id="secteur_id">
                                                <?php $__currentLoopData = $secteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secteur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($secteur->id); ?>"><?php echo e($secteur->nom_secteur); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                        </div>
                    </div>
