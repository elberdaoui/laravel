                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('profile_image') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="profile_image" type="file" class="form-control" name="profile_image" value="<?php echo e(old('profile_image')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('role') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="role" type="text" class="form-control" name="role" value="<?php echo e(old('role')); ?>" required autofocus>
